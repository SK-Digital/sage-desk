    ...
    <ComponentCard title="Modal Based Alerts">
      <div className="flex flex-wrap items-center gap-3">
        <button
          ...
          className="px-4 py-3 text-sm font-medium text-white rounded-lg bg-primary shadow-theme-xs hover:bg-primary-dark"
        >
          Success Alert
        </button>
        <button
      ...
      >
        <div className="text-center">
          ...
          <div className="flex items-center justify-center w-full gap-3 mt-7">
            <button
              type="button"
              className="flex justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-lg bg-primary shadow-theme-xs hover:bg-primary-dark sm:w-auto"
            >
              Okay, Got It
            </button>
          </div>
