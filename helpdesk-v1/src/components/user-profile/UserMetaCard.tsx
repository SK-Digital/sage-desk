...
export default function UserMetaCard() {
  ...
  return (
    <>
      <div className="p-5 border border-brand-500 rounded-2xl dark:bg-gray-900 bg-white lg:p-6 hover:teal-glow">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="w-20 h-20 flex items-center justify-center rounded-full bg-brand-100">
              <AvatarText name="John Doe" className="h-20 w-20 text-2xl" />
            </div>
            ...
            <div className="custom-scrollbar h-[450px] overflow-y-auto px-2 pb-3">
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  <div className="col-span-2 lg:col-span-1">
                    <Label>Phone</Label>
                    <Input type="text" defaultValue="+44 1234 567890" />
                  </div>
                  <div className="col-span-2">
                    <Label>Bio</Label>
                    <Input type="text" defaultValue="IT Support Agent" />
                  </div>
                </div>
              </div>
            </div>
