...
export default function LeaverForm() {
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">New Leaver Ticket</h1>
      <form className="space-y-6">
        ...
        <div>
          <label className="block mb-1 font-medium text-gray-700 dark:text-gray-300">Leave Date</label>
        ...
        <button type="submit" className="px-6 py-2 rounded-lg bg-brand-500 text-white font-semibold hover:bg-brand-600 transition">Submit Leaver Ticket</button>
      </form>
    </div>
  );
} 